...
private _frameEh  = [[_man, _crate],PSA_fnc_onEachCrateFrame] call PSA_fnc_addToClientFrameTasks;//addMissionEventHandler ["EachFrame", {call PSA_fnc_onEachCrateFrame}];
