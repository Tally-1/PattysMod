...
private _titlePos  = [_xPos, _yPos-(_titleSize*1.5), _titleSize,_titleSize/_ratio]; //[_xPos, _yPos,_width] call PTTY_fnc_formatPosCenterSquare;
private _top       = _yPos;
...
private _dataArr = [ 
	...
	["hide",                   PTTY_fnc_hideProgressBar],
	["show",                   PTTY_fnc_showProgressBar],
	["setProgress",           PTTY_fnc_setProgressOnBar],
	["setTitle",           PTTY_fnc_setProgressBarTitle],
	["setFillColor",   PTTY_fnc_setProgressBarFillColor],
	["setFrameColor", PTTY_fnc_setProgressBarFrameColor],
	["setTitleColor", PTTY_fnc_setProgressBarTitleColor]
];
